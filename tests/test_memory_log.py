...
from marvel.graph.propagation import Propagator
from marvel.agents.managers.portfolio_manager import create_portfolio_manager
...
class TestDeferredReflection:
    ...
    def test_fetch_returns_valid_ticker(self):
        ...
        mock_graph = MagicMock(spec=MarvelGraph)
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = MarvelGraph._fetch_returns(mock_graph, "688017", "2026-01-05")
    ...
    def test_fetch_returns_too_recent(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = MarvelGraph._fetch_returns(mock_graph, "NVDA", "2026-04-19")
    ...
    def test_fetch_returns_delisted(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            mock_ticker_cls.return_value = m
            raw, alpha, days = MarvelGraph._fetch_returns(mock_graph, "XXXXXFAKE", "2026-01-10")
        assert raw is None and alpha is None and days is None
    ...
    # MarvelGraph._resolve_pending_entries
    ...
    def test_resolve_skips_other_tickers(self, tmp_path):
        ...
        MarvelGraph._resolve_pending_entries(mock_graph, "NVDA")
...
class TestPortfolioManagerInjection:
    ...
    def test_pm_returns_rendered_markdown_with_rating(self):
        ...
        # Executable price levels were removed framework-wide (see
        # TraderProposal's docstring): the renderer must never emit one.
...
class TestLegacyRemoval:
    ...
    def test_financial_situation_memory_removed(self):
        ...
        import marvel.agents.utils.memory as m
    ...
    def test_reflect_and_remember_removed(self):
        """MarvelGraph must not expose reflect_and_remember."""
        assert not hasattr(MarvelGraph, "reflect_and_remember")
