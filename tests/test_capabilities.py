...
from marvel.llm_clients.capabilities import get_capabilities
from marvel.llm_clients.openai_client import MinimaxChatOpenAI
...
def test_explicit_tool_choice_is_dropped_for_unsupported_model():
    ...
    from marvel.llm_clients.openai_client import DeepSeekChatOpenAI
...
def test_optional_tool_call_returning_none_still_falls_back_to_free_text():
    ...
    from marvel.agents.utils.structured import invoke_structured_or_freetext
