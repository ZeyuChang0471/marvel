...
DEFAULT_CONFIG = {
    ...
    "results_dir": os.getenv("MARVEL_RESULTS_DIR", os.path.join(_MARVEL_HOME, "logs")),
    "data_cache_dir": os.getenv("MARVEL_CACHE_DIR", os.path.join(_MARVEL_HOME, "cache")),
    "memory_log_path": os.getenv("MARVEL_MEMORY_LOG_PATH", os.path.join(_MARVEL_HOME, "memory", "trading_memory.md")),
