...
MARVEL 的数据层与 7 个 Agent 实现绝大部分来自上游 [simonlin1212/TradingAgents-Astock](https://github.com/simonlin1212/tradingagents-astock)。如果这个工具帮到了你的投研工作流，欢迎支持**上游原作者** ☕

<p align="center">
  <img src="./assets/wechat-sponsor.jpg" width="240" alt="上游作者微信赞赏码">
</p>
<p align="center">
